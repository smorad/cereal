...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--dataset", choices=DATASETS.keys(), default="daily-min", help="Sequence dataset to train on.")
    parser.add_argument("--epochs", type=int, default=20, help="Training epochs.")
    parser.add_argument("--batch-size", type=int, default=64, help="Mini-batch size.")
    parser.add_argument("--context-length", type=int, default=30, help="History window length for each sample.")
    parser.add_argument("--prediction-length", type=int, default=1, help="Number of steps to predict ahead.")
    parser.add_argument("--hidden-size", type=int, default=128, help="Hidden size of the simple RNN.")
    parser.add_argument("--learning-rate", type=float, default=1e-3, help="Adam learning rate.")
    parser.add_argument("--train-fraction", type=float, default=0.85, help="Fraction of the series used for the training split.")
    parser.add_argument("--prefetch-size", type=int, default=256, help="Samples to prefetch inside DiskSampleSource.")
    parser.add_argument("--cache-dir", type=str, default=None, help="Optional directory for caching raw CSV files.")
    parser.add_argument("--seed", type=int, default=0, help="Random seed for both model and loader state.")
    return parser.parse_args()


def _build_pipeline(dataset_cls: DatasetCls, *, split: str, ordering: str, args: argparse.Namespace) -> DataLoader:
