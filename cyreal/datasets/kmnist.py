"""Kuzushiji-MNIST dataset helpers."""
...
class KMNISTDataset(DatasetProtocol):
    ...
    def make_disk_source(
        ...
        *,
        ...
        _ensure_file(images_gz, KMNIST_URLS[f"{split}_images"])
        _ensure_file(labels_gz, KMNIST_URLS[f"{split}_labels"])
        ...
        if num_images != num_labels:
            raise ValueError("KMNIST image/label counts do not match.")
